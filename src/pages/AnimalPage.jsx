          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-[#e08a4a]/25 p-6" style={{ background: 'rgba(60, 20, 24, 0.55)' }}>
              <div className="mb-6 flex items-center gap-3">
                ...
                <p className="type-h3 text-2xl tracking-wide text-[#e08a4a] md:text-[28px]" style={{ fontWeight: 500 }}>Never Do This</p>
              </div>
              <ul>
            ...
            <div className="rounded-2xl border border-[#38a169]/25 p-6" style={{ background: 'rgba(16, 40, 30, 0.55)' }}>
              <div className="mb-6 flex items-center gap-3">
                ...
                <p className="type-h3 text-2xl tracking-wide text-[#6ee7a1] md:text-[28px]" style={{ fontWeight: 500 }}>Always Do This</p>
              </div>
              <ul>
