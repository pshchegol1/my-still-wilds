...
export const PACK_LISTS = {
  dayHike: {
    ...
    items: [
      { label: 'Bear Spray', icon: '/icons/hike/bear-spray.png' },
      { label: 'Water — 2L Minimum', icon: '/icons/hike/water-bottle.png' },
      { label: 'Trail Map + Compass', icon: '/icons/hike/map-compass.png' },
      { label: 'First Aid Kit', icon: '/icons/hike/first-aid-kit.png' },
      { label: 'Headlamp + Extra Batteries', icon: '/icons/hike/headlamp.png' },
      { label: 'Food + Extra Snacks', icon: '/icons/hike/snacks.png' },
      { label: 'Rain Jacket', icon: '/icons/hike/rain-jacket.png' },
      { label: 'Sunscreen + Sunglasses', icon: '/icons/hike/sunscreen-sunglasses.png' },
      { label: 'Bug Spray / DEET', icon: '/icons/hike/bug-spray.png' },
      { label: 'Fully Charged Phone' },
      { label: 'Bear Bell', icon: '/icons/hike/bear-bell.png' },
      { label: 'Daypack 20–35L', icon: '/icons/hike/backpack.png' },
    ],
  },
  multiDay: {
    ...
    items: [
      { label: 'Bear Spray', icon: '/icons/hike/bear-spray.png' },
      { label: 'Tent + Sleeping Bag / Pad', icon: '/icons/hike/tent-sleeping-bag.png' },
      { label: 'Water Filter / Purification Tablets', icon: '/icons/hike/water-filter.png' },
      { label: 'Bear Canister For Food', icon: '/icons/hike/bear-canister.png' },
      { label: 'Satellite Communicator (SPOT/Garmin)', icon: '/icons/hike/satellite-communicator.png' },
      { label: 'Topographic Map + Compass + GPS', icon: '/icons/hike/topo-map-gps.png' },
      { label: 'Camp Stove + Fuel + Cookware', icon: '/icons/hike/camp-stove.png' },
      { label: 'Comprehensive First Aid Kit', icon: '/icons/hike/first-aid-kit.png' },
      { label: 'Headlamp + Backup Light', icon: '/icons/hike/headlamp.png' },
      { label: 'Full Clothing Layers System', icon: '/icons/hike/clothing-layers.png' },
      { label: 'Solar Charger / Power Bank', icon: '/icons/hike/solar-charger.png' },
      { label: 'Trowel + Waste Bags (Leave No Trace)', icon: '/icons/hike/trowel-waste-bags.png' },
    ],
  },
};
